...
/**
 * Check if a KeyValue is a string only composed of numbers (and optionally white space).
 */
class NumericalValidator extends KeyValueValidator
{
   ...
   {
      $is = false;
      $pattern = $this->isWhiteSpaceAllowed() ? '/^[0-9\s]{1,}$/' : '/^[0-9]{1,}$/';
